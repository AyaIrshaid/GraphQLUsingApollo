...
public class CancelTripMutation: GraphQLMutation {
  ...
  public struct Data: CodegenConfig.SelectionSet {
    ...
    public static var __parentType: ApolloAPI.ParentType { CodegenConfig.Objects.Mutation }
    ...
    public struct CancelTrip: CodegenConfig.SelectionSet {
      public let __data: DataDict
      public init(_dataDict: DataDict) { __data = _dataDict }

      public static var __parentType: ApolloAPI.ParentType { CodegenConfig.Objects.TripUpdateResponse }
      public static var __selections: [ApolloAPI.Selection] { [
